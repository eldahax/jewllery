        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-start gap-12 md:gap-4">
          ...
          <div className="w-full md:w-[35%] flex flex-col gap-8 text-[15px] tracking-widest uppercase text-[#2A2421]">
            ...
            <div>
              ...
              <a 
                ...
                className="text-[#1A080B]/60 lowercase tracking-normal hover:underline"
              >
            ...
            <div>
              ...
              <span className="text-[#1A080B]/60 tracking-normal">
                (000) 000-0000
              </span>
            ...
            <div>
              ...
              <div className="flex gap-4 text-xs text-[#1A080B]/70">
                ...
                <a href="#linkedin" className="hover:text-black">
                  LN
                </a>
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <label className="text-[10px] tracking-widest uppercase text-[#1A080B]/50 font-medium">
                Name
              </label>
