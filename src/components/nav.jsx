    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full bg-[#FCFBF9]/90 backdrop-blur-md border-b border-[#1A080B]/10 shadow-sm">
        <div className="flex items-center justify-between px-6 md:px-12 py-4 md:py-5">
          ...
          >
            <span
              className={`w-6 h-[1px] bg-[#1A080B] transition-transform duration-300 ease-in-out ${
                open ? "rotate-45 translate-y-2" : ""
              }`}
            />

            <span
              className={`w-6 h-[1px] bg-[#1A080B] transition-opacity duration-300 ease-in-out ${
                open ? "opacity-0" : ""
              }`}
            />
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-[11px] tracking-widest uppercase font-medium text-[#1A080B]/70">
            ...
            <Link
              to="/home"
              className="hover:text-[#1A080B] border-b border-transparent hover:border-[#1A080B] pb-0.5 transition-all"
            >
              Home
            </Link>
            ...
            {isLoggedIn ? (
              <div className="flex gap-4 items-center">
                ...
                <button
                  ...
                  className="hover:text-[#1A080B] transition-colors uppercase"
                >
                  Logout
                </button>
              ...
              <>
                <Link
                  to="/login"
                  className="hover:text-[#1A080B] transition-colors"
                >
                  Login
                </Link>
                ...
                <Link
                  to="/signup"
                  className="hover:text-[#1A080B] bg-[#1A080B] text-white px-3 py-1.5 rounded-[4px] hover:bg-[#4A0E17] transition-all"
                >
                  Signup
                </Link>
              </>
        ...
        >
          <div className="flex flex-col gap-5 px-8 pt-4 pb-8 text-[11px] tracking-[0.2em] uppercase text-[#1A080B]/80 font-medium">
            ...
            {isLoggedIn ? (
              <button
                onClick={handleLogout}
                className="text-left text-[#1A080B]"
              >
                Logout
              </button>
            ) : (
